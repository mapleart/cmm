...
class CookieConsentManager {
    ...
    private $github_repo = 'https://raw.githubusercontent.com/your-repo/cookie-consent/main/';
    
    // Файлы для скачивания из репозитория
    private $files = [
        'cookie-consent-vanilla.js' => 'assets/cookie-consent/cookie-consent-vanilla.js',
        'cookie-consent-styles.css' => 'assets/cookie-consent/cookie-consent-styles.css'
    ];
 ...
 */
function cookie_consent_init($config = []) {
    ...
    echo '<script src="/assets/cookie-consent/cookie-consent-vanilla.js" data-skip-moving="true"></script>' . "\n";
}
...
function cookie_consent_check($category) {
    $consent = $_COOKIE['iq_cookie_consent'] ?? '';
